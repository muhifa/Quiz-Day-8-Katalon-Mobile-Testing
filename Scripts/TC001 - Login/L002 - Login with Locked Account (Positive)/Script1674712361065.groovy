...
Mobile.setText(findTestObject('Object Repository/android.widget.EditText (2)'), 'alice@example.com', 0)

Mobile.setEncryptedText(findTestObject('Object Repository/android.widget.EditText (3)'), 'dbXIBZ66cuht4KTRMDozZw==', 0)
